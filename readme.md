...
| Microsoft.UI.Notifications | Notifications Package - Generate tile, toast, and badge notifications for Windows 10 via code.  Includes intellisense support to avoid having to use the XML syntax |
| Microsoft.UI.Notifications.Javascript | Notification Packages for JavaScript |
